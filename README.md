...
-Not sure why when I display an alert, the keyboard disappears, but then reappears when the alert is dismissed. Minor bug, but don't know why the keyboard state changes.
